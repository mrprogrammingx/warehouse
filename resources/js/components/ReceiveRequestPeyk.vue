    ...
    <div class="containe  r1 p-5 p-md-5 pt-4 height-100 w-100">
        ...
        <div class="switch-holder float-left">
            <div class="switch-label">
                <i class="fa fa-bluetooth-b"></i><span>Ready to start</span>
            </div>
        ...
        <h4 class="mb-4 my-font-size">Requests pending delivery</h4>
            ...
            <table id="table_status" class="table table-bordered style_table">
                ...
                <tr v-for="(request,index) in request_all" :key="index">
                    ...
                    <td label="Delivery status">
                        ...
                        <i v-if="request.status.id==5" class="badge badge-success">delivered</i>
                    </td>
